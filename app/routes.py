...
from app.controllers import signup, verify, login, cities, buses_in_city, get_bookings, book_bus, payment
...
routes.add_url_rule('/order/payment_confirmation', view_func=payment, methods=['POST'])